...
let VSCODE_WASM_MODULE_PATH_NODE_JS = '../public/demo/dist/quick-lint-js-vscode.wasm';
...
async function createProcessFactoryAsync() {
    if (typeof window === 'undefined') {
        ...
        let wasmCode = await fs.promises.readFile(path.join(
            __dirname,
            VSCODE_WASM_MODULE_PATH_NODE_JS,
        ));
