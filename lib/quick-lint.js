...
module.exports.lint = async (source) => {
    ...
    const documentForWebDemo = await quickLintProcess.createDocumentForWebDemoAsync();
    
    documentForWebDemo.setText(source);
    const diagnostics = documentForWebDemo.lint();
